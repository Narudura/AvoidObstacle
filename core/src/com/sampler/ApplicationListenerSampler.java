...
public class ApplicationListenerSampler extends SampleBase {
    ...
    private static final Logger log = new Logger(ApplicationListenerSampler.class.getName(), Logger.DEBUG);
	...
	@Override
	public void create() {
		// used to initial game and load resources
	...
	public void render() {
		...
		//used to update and render the game elements called 60times per second
